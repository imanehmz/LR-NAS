...
parser.add_argument('--data', type=str, default='../../tiny-imagenet-200/', help='location of the data corpus')
...
parser.add_argument('--save', type=str, default='EXP-tiny', help='experiment name')
